...
/**
 * The mod_sforum subscription deleted event.
 *
 * @package    mod_sforum
...
/**
 * The mod_sforum subscription deleted event class.
 *
 * @property-read array $other {
 *      Extra information about the event.
 *
 *      - int sforumid: The id of the sforum which has been unsusbcribed from.
 * }
 *
 * @package    mod_sforum
 * @since      Moodle 2.7
...
class subscription_deleted extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' unsubscribed the user with id '$this->relateduserid' to the sforum with " .
    ...
    public static function get_name() {
        return get_string('eventsubscriptiondeleted', 'mod_sforum');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'sforum', 'unsubscribe', 'view.php?f=' . $this->other['sforumid'],
