...
/**
 * The mod_sforum discussion_subscription created event.
 *
 * @package    mod_sforum
...
/**
 * The mod_sforum discussion_subscription created event class.
 *
...
class discussion_subscription_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventdiscussionsubscriptioncreated', 'mod_sforum');
    }
